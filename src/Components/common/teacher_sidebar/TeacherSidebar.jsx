...
const TeacherSidebar = () => {
  ...
  <img src={'https://gotocourse.com/logo.svg'} alt="Logo" className="p-2 h-full w-[3cm]" />
      ...
      <div className="my-4 text-white cta-cont">
        ...
        <button className="bg-blue-500 opacity-60 py-2 px-4 rounded-md w-full my-2 hover:bg-opacity-80 flex items-center">
        <PrinterIcon class="h-6 w-6 text-white mr-2" />
      ...
      <div className="flex-grow flex flex-col justify-end">
        ...
        <PlusSmallIcon class="h-6 w-6 text-blue-500 mr-1"/>
          <p className='cta-cont'>New Content</p>
          <EllipsisVerticalIcon class="h-6 w-6 text-gray-500 ml-5"/>
